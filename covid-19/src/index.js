const axios = require("axios"); //axios is a dependancy to fetch a data from outside our application.
...
results.style.display = "none"; //in the initial state, css results are not displayed
